...
def get_prediction(match_id):
    ...
    model_dict = {'0': r'.\models732\0-10\pipeline\pipeline.json',
                  '1': r'.\models732\5-15\pipeline\pipeline.json',
                  '2': r'.\models732\15-25\pipeline\pipeline.json',
                  '3': r'.\models732\30\pipeline\pipeline.json'}
