...
if __name__ == '__main__':
    ...
    train_mode = False
    model_path = r'D:\РАБОТЫ РЕПОЗИТОРИИ\Репозитории\Forecasting model for Major\models\30\pipeline\pipeline.json'
    ...
    df_encoded = df_encoded[(df_encoded['time'] > 30.0)]
    ...
    if train_mode:
        df_model_train_X, df_model_test_X, df_model_train_y, df_model_test_y = train_test_split(df_model_features,
                                                                                                ...
                                                                                                test_size=0.2,
                                                                                                random_state=42)
        clf_model = FedotModel(x_data=df_model_train_X, y_data=df_model_train_y, time=30)
        clf_model.run_model()
